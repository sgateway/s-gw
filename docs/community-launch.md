...
It is a preview, not a hardened enterprise secrets platform. macOS is the primary path today, and Windows and Linux are preview. The broker and clients are open source; distributed packages include a proprietary compiled Rust execution core.

...
<p align="center">
  <a href="https://github.com/barryqy/s-gw/actions/workflows/ci.yml"><img alt="CI" src="https://github.com/barryqy/s-gw/actions/workflows/ci.yml/badge.svg"></a>
...
Requirements: Node.js 20 or newer. Building the native macOS surfaces also requires a Swift toolchain.
...
Prebuilt, signed downloads are not published yet. Local installer artifacts can be built with `npm run build:installers`; the resulting macOS DMG is ad-hoc signed and unnotarized, and the Windows package is unsigned preview software.
...
- Signed desktop downloads are not published yet.
